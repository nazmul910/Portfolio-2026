...
<div ref={description} className={styles.right}>
    ...
    <div data-scroll data-scroll-speed={0.1} className={styles.over1}>
        <a href="https://drive.google.com/file/d/1WpmXO8AdngB9uZZg6n2vlLWxFWPbIqk5/view?usp=sharing" target="_blank" >
